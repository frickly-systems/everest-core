...
public:
    ...
    evse_board_supportImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<TIDA010939Driver>& mod, Conf& config) :
...
private:
    const Everest::PtrContainer<TIDA010939Driver>& mod;
    const Conf& config;
